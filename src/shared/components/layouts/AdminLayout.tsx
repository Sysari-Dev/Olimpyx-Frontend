      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen">
        ...
        <div className="flex-1 p-2 pb-0 overflow-hidden flex flex-col">
          <main className="flex-1 bg-dark rounded-tl-3xl overflow-y-auto custom-scrollbar relative shadow-2xl shadow-black/50">
            <div className="p-6 md:p-10 max-w-350 mx-auto min-h-full">
              <Outlet />
            </div>
          </main>
          <footer className="h-8 bg-background flex items-center justify-center px-6 shrink-0"></footer>
        </div>
      </div>
      <BaseModal
        ...
        description="Estás a punto de salir del sistema de gestión Olimpyx. Deberás ingresar tus credenciales nuevamente para acceder."
