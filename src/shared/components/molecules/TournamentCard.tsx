...
const TournamentCard = ({ tournament, onClick }: TournamentCardProps) => {
  // Configuración visual según el deporte
  const isVoley = tournament.sport === "Vóley";

  const statusStyles = {
    REGISTRATION: "bg-blue-500/10 text-blue-600",
    IN_PROGRESS: "bg-tertiary/10 text-tertiary animate-pulse",
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-start">
        ...
        <span
          className={`text-[9px] font-black uppercase px-2 py-1 rounded-lg tracking-widest ${statusStyles}`}
        >
      ...
      <div className="mt-auto pt-4 border-t border-light/50 flex flex-col gap-2">
        ...
        {/* Indicador de acción (solo visible en hover) */}
