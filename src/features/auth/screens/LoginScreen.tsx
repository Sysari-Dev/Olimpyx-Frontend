    ...
    <div className="h-screen w-full flex flex-col items-center justify-center bg-linear-to-br from-primary via-light to-secondary relative overflow-hidden font-sans p-4">
      ...
      <div className="bg-white w-full max-w-112.5 p-8 md:p-12 rounded-2xl shadow-2xl shadow-dark-black/10 relative z-10 border border-light/50">
        <div className="flex flex-col items-center mb-10">
          <div className="w-12 h-12 bg-accent rounded-2xl flex items-center justify-center shadow-lg shadow-accent/20 mb-6">
          </div>
          <h1 className="text-3xl font-black text-dark tracking-tighter">¡Bienvenido!</h1>
        ...
        <form className="space-y-6">
          <div className="space-y-2">
            <label className="text-[11px] font-black text-dark/50 uppercase tracking-[0.15em] ml-1">Email</label>
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center px-1">
              <label className="text-[11px] font-black text-dark/50 uppercase tracking-[0.15em]">Password</label>
              <button type="button" className="text-[11px] font-bold text-accent hover:underline cursor-pointer">¿La olvidaste?</button>
            </div>
            <div className="relative group">
        ...
        <div className="mt-10 text-center">
          <p className="text-xs font-medium text-dark/40">
            ...
            <Link to="/" className="text-accent font-black hover:underline inline-block mt-1">Contáctanos en SYSARI</Link>
          </p>
        </div>
      </div>
    </div>
